...
export default function Aboutus() {
  return (
    <div className='abc'>
      ...
      <div className=" d-flex align-items-center row " style={{ margin: "0px", justifyContent: "center" }} >
        ...
        <div className="col-12 col-md-6 ">
          ...
          <div className="text-center my-4">
            <h1 style={{ color: 'rgb(197 178 0)',fontSize:"50px",letterSpacing:"2px" }} > Medi-Caps University</h1>
          </div>
      ...
      <div className="text-center my-4">
        <h1 style={{ color: 'rgb(197 178 0)', fontSize:"50px",letterSpacing:"2px"}}  >Officials</h1>
      </div>
