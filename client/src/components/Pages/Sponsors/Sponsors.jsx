...
export default function Sponsors() {
  return (
    <div style={{ color: "white" }}>
      <div className='first'>
        <h1 className='text-center m-4' id="Sponsorship" style={{ color: "#00FFD1" }}>Our Sponsors</h1>
      ...
      <div className='container' id="Sponsorship-Opportunities">
        <h1 className='text-center' style={{ color: "#00FFD1" }}>Sponsorship Opportunities 2K23</h1>
